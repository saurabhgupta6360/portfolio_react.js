        ...
        <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:-10">
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-6">
            <div className="col-span-2">
              <a
                href="#"
                className="flex items-center mb-2 text-2xl font-semibold text-[#fff] sm:mb-0 dark:text-white font-secondary"
              >
                Let's get in touch
              </a>
              <p className="my-4 font-light text-[#bcbcbc]">
            ...
            <div className="lg:mx-auto">
              <h2 className="mb-6 text-sm font-semibold text-[#fff] uppercase dark:text-white font-secondary">
                Company
              </h2>
              <ul className="text-[#bcbcbc]">
                <li className="mb-4 text-[#bcbcbc]">
